...
def compiledConvnet(input_shape=(101, 101, 3)):
...
def convnet(input_shape=(101, 101, 3)):
	model = Sequential()
...
def compiled_maxpool_simpler_1(input_shape=(101, 101, 3)):
...
def maxpool_simpler_1(input_shape=(101, 101, 3)):
	model = Sequential()
...
def compiled_maxpool_convnet(input_shape=(101, 101, 3)):
	model = convnet(input_shape)
	optimizer = Adam(lr = .0001, decay = 5e-5)
	model.compile(optimizer=optimizer,
	loss='binary_crossentropy',
...
def maxpool_convnet(input_shape=(101, 101, 3)):
	model = Sequential()
